...
void readADCs() {
  ...
  milliwatthours_ACC += busvoltage * current_mA; //maybe downshift 1024 here to save variable space - to check bits that are set &0x8000000 1/2 to overflow if set
  milliamphours_ACC += current_mA;               //if and op not 0 then clear bit &0x7fffffff another variable to track how many times reset, adds overhead though vs 64bit add
